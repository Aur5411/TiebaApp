...
import com.huanchengfly.tieba.post.api.models.protos.getUserByTiebaUid.GetUserByTiebaUidRequest
import com.huanchengfly.tieba.post.api.models.protos.getUserByTiebaUid.GetUserByTiebaUidRequestData
import com.huanchengfly.tieba.post.api.models.protos.getUserByTiebaUid.GetUserByTiebaUidResponse
...
object MixedTiebaApiImpl : ITiebaApi {
    ...
    override fun signFlow(forumId: String, forumName: String, tbs: String, fromWidget: String): Flow<SignResultBean> =
        RetrofitTiebaApi.OFFICIAL_TIEBA_API.signFlow(forumId, forumName, tbs, fromWidget)
    ...
    override fun fansPageFlow(page: Int, uid: Long?): Flow<FansPageBean> =
        RetrofitTiebaApi.OFFICIAL_TIEBA_API.fansPageFlow(page, uid)
    ...
    override fun getUserByTiebaUidFlow(tiebaUid: String): Flow<GetUserByTiebaUidResponse> {
        return RetrofitTiebaApi.OFFICIAL_PROTOBUF_TIEBA_V22_API.getUserByTiebaUidFlow(
            buildProtobufRequestBody(
                GetUserByTiebaUidRequest(
                    GetUserByTiebaUidRequestData(
                        common = buildCommonRequest(clientVersion = ClientVersion.TIEBA_V22),
                        tieba_uid = tiebaUid,
                    )
                ),
